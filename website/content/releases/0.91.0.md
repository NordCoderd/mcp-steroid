...
**[End User License Agreement (EULA)](https://github.com/jonnyzzz/mcp-steroid/releases/download/v0.91.0/LICENSE)** - By downloading and using this plugin, you agree to the terms of the EULA.
