...
// Calculate durations
val totalDuration = rootProxy.duration ?: 0L
val avgDuration = if (total > 0) totalDuration / total else 0L
val maxDuration = allTests.maxOfOrNull { it.duration ?: 0L } ?: 0L
val minDuration = allTests.filter { (it.duration ?: 0L) > 0 }.minOfOrNull { it.duration ?: 0L } ?: 0L
...
val slowestTests = allTests
    ...
    .sortedByDescending { it.duration ?: 0L }
    .take(5)
