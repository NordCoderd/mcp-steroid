...
class FilenameIndexPromptTest {
    ...
    fun `claude uses FilenameIndex to find files instead of Glob or Bash find`() {
        ...
        val prompt = buildString {
            ...
            appendLine()
            appendLine("Read `mcp-steroid://skill/execute-code-file-ops` for the correct file-discovery pattern.")
            appendLine()
        ...
        check(usedFilenameIndex) {
            buildString {
                ...
                appendLine()
                appendLine("The prompts in execute-code-file-ops.md need to explicitly state:")
